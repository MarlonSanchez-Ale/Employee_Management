...
async function handler(req, res) {
    ...
    switch(method){
        case "GET":
            (0,_database_controller__WEBPACK_IMPORTED_MODULE_1__/* .getAllEmployees */ .XA)(req, res);
            break;
        case "POST":
            (0,_database_controller__WEBPACK_IMPORTED_MODULE_1__/* .createEmployee */ .r8)(req, res);
            break;
        default:
            res.setHeader("Allow", [
                "GET",
...
var __webpack_exports__ = __webpack_require__.X(0, [745,131], () => (__webpack_exec__(701)));
